...
func TestNewSendeoCargo(t *testing.T) {
	tests := []struct {
		want cargo.Shipper
	}{
		// TODO: Add test cases.
	...
	for i, tt := range tests {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			if got := NewSendeoCargo(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewSendeoCargo() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_sendeoCargo_CancelCargo(t *testing.T) {
	type fields struct {
		Cargo *cargo.Cargo
	}
	type args struct {
...
func Test_sendeoCargo_CreateCargo(t *testing.T) {
	type fields struct {
		Cargo *cargo.Cargo
	}
	type args struct {
...
func Test_sendeoCargo_WhereIsTheCargo(t *testing.T) {
	type fields struct {
		Cargo *cargo.Cargo
	}
	type args struct {
