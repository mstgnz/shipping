...
func (u upsCargo) CreateCargo(data cargo.ShippingData) (map[string]any, error) {
	var err error
...
func (u upsCargo) WhereIsTheCargo(data cargo.ShippingData) (map[string]any, error) {
	//TODO implement me
	panic("implement me")
}

func (u upsCargo) CancelCargo(data cargo.ShippingData) (map[string]any, error) {
	//TODO implement me
	panic("implement me")
}
