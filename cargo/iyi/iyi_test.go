...
func TestNewIyiCargo(t *testing.T) {
	tests := []struct {
		want cargo.Shipper
	}{
		// TODO: Add test cases.
	...
	for i, tt := range tests {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			if got := NewIyiCargo(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewIyiCargo() = %v, want %v", got, tt.want)
			}
		})
	}
}

func Test_iyiCargo_CancelCargo(t *testing.T) {
	type fields struct {
		Cargo *cargo.Cargo
	}
	type args struct {
	...
	for i, tt := range tests {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			got, err := ic.CancelCargo(tt.args.data)
...
func Test_iyiCargo_CreateCargo(t *testing.T) {
	type fields struct {
		Cargo *cargo.Cargo
	}
	type args struct {
	...
	for i, tt := range tests {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			got, err := ic.CreateCargo(tt.args.data)
			if (err != nil) != tt.wantErr {
...
func Test_iyiCargo_WhereIsTheCargo(t *testing.T) {
	type fields struct {
		Cargo *cargo.Cargo
	}
	type args struct {
	...
	for i, tt := range tests {
		t.Run(strconv.Itoa(i), func(t *testing.T) {
			...
			got, err := ic.WhereIsTheCargo(tt.args.data)
			if (err != nil) != tt.wantErr {
